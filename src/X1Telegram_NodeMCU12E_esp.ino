...
// --------------------------
// Optimizado para ESP8266 NodeMCU 12E, aunque puede funcionar en cualquier ESP8266 y ESP32.
// 
...
if (msg.text == "Ascii"){ 
bot.sendMessage("Combines Ascii with: x1t, msx, patriot, elvis, geist, sid, badcat, alien, msxvr, space, computer, smith, linux, neo, starwars");
