...
// sotanomsxbbs.org:23
// -----------------------
// Optimizado para ESP8266 01, aunque puede funcionar en cualquier ESP8266 y ESP32 (no probado en éste último).
// 
...
#define WIFI_SSID "BAT_CUEVA" // Pon aqui tu red WI-FI
#define WIFI_PASS "sargamassa" // Pon aqui tu contraseña
...
#define BOT_TOKEN "5736391602:AAHM7rKSGaTd9mlCla066pOi00rgJiokaBA" // Ya puedes pegar aqui abajo el TOKEN de tu BOT.

// Puedes usar éste grupo para tus pruebas o añadir otro cualquiera. Yo uso el IDBot para extraer el Token.
// Para que X1Telegram funcione tu BOT debe ser administrador del grupo donde se vaya a añadir. Aveces Telegram se toma unos minutos con eso. ???
...
bot.setChatID(CHAT_ID);
  ...
  String sticker = F("CAACAgQAAxkBAAEGY0Njbrfwy1f4hIUEPXm1MfTlSumm_wACPgwAAjVKMVIeTfBrM61zfCsE"); // ID de Sticker "X1Telegram alienigenas". He usado el BOT "Get Sticker ID"
  ...
  bot.sendMessage(F("X1Telegram iniciado por xxxxxx_BOT!")); //Pon aqui tu nick para que sepamos quien mas hay usando X1Telegram.
...
// if (msg.OTA && msg.chatID == "xxxxxxx") bot.update(); // Actualizar si el archivo BIN lo envía una persona famosa (administrador).
...
// Keywords LED
// Esto activa y desactiva la salida digital correspondiente del Esp01, obviamente se pueden usar otras. 
// En este caso la el PIN 2 va asociado al led que ya viene incluido en la placa. 
...
// la puerta de un garaje, luces de casa, etc ...
 ...
 if (msg.text == "/ledon") {
 digitalWrite(ledPin, HIGH);   // Activa, enciende el LED. Pone el PIN2 en HIGH.
 ...
 digitalWrite(ledPin, LOW);    // Apaga el LED. Pone el PIN2 en LOW.
...
Serial.print("xxxxxx BOT: "); // Aquí defino manualmente el nombre de mi BOT. Nombra manualmente el tuyo :)
...
void connectWiFi() {
  ...
  Serial.begin(9600); // Establece el puerto serie a 9600 bps.
  Serial.println();
...
// Esto será mostrado si se resetea con el boton reset del ESP01.
